    ...
    function generateMetadata(
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                uint2str(marriageId),
                '",',
                '"description": "Marriage certificate between ',
                addressToString(bride),
                " and ",
                addressToString(groom),
                '",',
                '"image": "ipfs://path_to_image",',
                '"attributes": [',
                '{"trait_type": "Bride Address", "value": "',
                addressToString(bride),
                '"},',
                '{"trait_type": "Groom Address", "value": "',
                addressToString(groom),
                '"},',
                '{"trait_type": "Bride NID", "value": "',
                uint2str(brideNID),
                '"},',
                '{"trait_type": "Groom NID", "value": "',
                uint2str(groomNID),
                '"},',
                '{"trait_type": "Date", "value": "',
                uint2str(date),
                '"},',
                '{"trait_type": "Is Divorced", "value": "',
                isDivorced ? "true" : "false",
                '"},',
                '{"trait_type": "Bride Signed", "value": "',
                brideSigned ? "true" : "false",
                '"},',
                '{"trait_type": "Groom Signed", "value": "',
                groomSigned ? "true" : "false",
                '"},',
                '{"trait_type": "Judge Signed Divorce", "value": "',
                judgeSignedDivorce ? "true" : "false",
                '"}'
                "]}"
            )
        );
    ...
    function generateDivorceMetadata(
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                uint2str(marriageId),
                '",',
                '"description": "Divorce certificate between ',
                addressToString(bride),
                " and ",
                addressToString(groom),
                '",',
